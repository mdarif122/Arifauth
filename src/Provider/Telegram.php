...
use Arifauth\HttpClient\Util;
use Arifauth\Data\Collection;
use Arifauth\User\Profile;
use Arifauth\Adapter\AbstractAdapter;
use Arifauth\Adapter\AdapterInterface;
 ...
 *   ];
 *
 *   $adapter = new Arifauth\Provider\Telegram($config);
 *
 *   try {
