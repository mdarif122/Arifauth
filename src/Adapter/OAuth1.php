...
namespace Arifauth\Adapter;

use Arifauth\Exception\Exception;
use Arifauth\Exception\InvalidApplicationCredentialsException;
use Arifauth\Exception\AuthorizationDeniedException;
use Arifauth\Exception\InvalidOauthTokenException;
use Arifauth\Exception\InvalidAccessTokenException;
use Arifauth\Data;
use Arifauth\HttpClient;
use Arifauth\Thirdparty\OAuth\OAuthConsumer;
use Arifauth\Thirdparty\OAuth\OAuthRequest;
use Arifauth\Thirdparty\OAuth\OAuthSignatureMethodHMACSHA1;
use Arifauth\Thirdparty\OAuth\OAuthUtil;
...
abstract class OAuth1 extends AbstractAdapter implements AdapterInterface
{
     ...
     * @throws \Arifauth\Exception\HttpClientFailureException
     * @throws \Arifauth\Exception\HttpRequestFailedException
     ...
     *
     * @return \Arifauth\Data\Collection
     * @throws InvalidOauthTokenException
     */
     ...
     * Arifauth will consider any HTTP status code that is different than '200 OK' as an ERROR.
     *
     * @param string $url
     * @param string $method
     * @param array $parameters
