...
use Arifauth\Exception\InvalidAuthorizationStateException;
use Arifauth\Exception\InvalidAuthorizationCodeException;
...
abstract class OAuth2 extends AbstractAdapter implements AdapterInterface
{
     ...
     *
     * @throws \Arifauth\Exception\InvalidAuthorizationCodeException
     * @throws \Arifauth\Exception\AuthorizationDeniedException
     */
     ...
     * RFC6749 and OAuth specifications, Arifauth will consider any HTTP
