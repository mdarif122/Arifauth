<?php
/**
 * Basic autoloader for Arifauth library which you may use as it is or as a template
...
if (version_compare(PHP_VERSION, '5.4.0', '<')) {
    throw new Exception('Arifauth 3 requires PHP version 5.4 or higher.');
}

/**
 * Register the autoloader for Arifauth classes.
 *
...
spl_autoload_register(
    function ($class) {
        // project-specific namespace prefix. Will only kicks in for Arifauth's namespace.
        $prefix = 'Arifauth\\';
